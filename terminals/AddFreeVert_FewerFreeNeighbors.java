...
public class AddFreeVert_FewerFreeNeighbors extends GPNode {

	private static final long serialVersionUID = -2534468795456857335L;
	
	public String toString() { return "Add_FewerFNeighb"; }
	...
	public void eval(final EvolutionState state, final int thread,
		...
		mispd.setResult(Terminal.addFreeVertFewerFreeNeighbors(mispd.getInstance().getIndependentSet()));
